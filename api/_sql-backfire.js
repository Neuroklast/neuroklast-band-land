 ...
 */
export function detectSqlInjection(req) {
  const sources = []

  // Check query parameters
  if (req.query) {
    sources.push(...Object.values(req.query).filter(v => typeof v === 'string'))
  }

  // Check request body string fields
  if (req.body && typeof req.body === 'object') {
    sources.push(...Object.values(req.body).filter(v => typeof v === 'string'))
  }
 ...
 */
export function setBackfireHeaders(res) {
 ...
 */
export function generateBackfireBody() {
 ...
 */
export async function handleSqlInjectionBackfire(req, res) {
