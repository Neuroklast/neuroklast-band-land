...
const translations: Record<string, Record<Locale, string>> = {
  ...
  'rules.tarpitOnRobotsViolationTip':{ en: 'Applies artificial delays to bots that access paths forbidden by robots.txt Disallow directives. Slows down unauthorized crawlers.', de: 'Wendet künstliche Verzögerungen auf Bots an, die auf durch robots.txt-Disallow-Regeln verbotene Pfade zugreifen. Verlangsamt unautorisierte Crawler.' },
  ...
  // ── Attacker Profile Dialog ─────────────────────────────────────────
  'profile.title':                { en: 'ATTACKER PROFILE // DETAILED ANALYSIS', de: 'ANGREIFER-PROFIL // DETAILANALYSE' },
  'profile.loading':              { en: 'LOADING PROFILE...', de: 'LADE PROFIL...' },
  'profile.failedToLoad':         { en: 'FAILED TO LOAD', de: 'LADEN FEHLGESCHLAGEN' },
  'profile.ipHash':               { en: 'IP Hash (SHA-256)', de: 'IP-Hash (SHA-256)' },
  'profile.ipHashTip':            { en: 'GDPR-compliant SHA-256 hash of the attacker IP address', de: 'DSGVO-konformer SHA-256-Hash der Angreifer-IP-Adresse' },
  'profile.currentScore':         { en: 'Current Threat Score', de: 'Aktueller Bedrohungsscore' },
  'profile.currentScoreTip':      { en: 'Cumulative threat score based on all detected suspicious activities', de: 'Kumulativer Bedrohungsscore basierend auf allen erkannten verdächtigen Aktivitäten' },
  'profile.totalIncidents':       { en: 'Total Incidents', de: 'Vorfälle gesamt' },
  'profile.totalIncidentsTip':    { en: 'Total number of security incidents recorded for this IP', de: 'Gesamtzahl der für diese IP aufgezeichneten Sicherheitsvorfälle' },
  'profile.firstSeen':            { en: 'First Seen', de: 'Erstmals gesehen' },
  'profile.firstSeenTip':         { en: 'Timestamp of the first recorded activity from this IP', de: 'Zeitstempel der ersten aufgezeichneten Aktivität dieser IP' },
  'profile.lastSeen':             { en: 'Last Seen', de: 'Zuletzt gesehen' },
  'profile.lastSeenTip':          { en: 'Timestamp of the most recent activity from this IP', de: 'Zeitstempel der letzten aufgezeichneten Aktivität dieser IP' },
  'profile.uaDiversity':          { en: 'UA Diversity', de: 'UA-Diversität' },
  'profile.uaDiversityTip':       { en: 'Number of different User-Agent strings used — high diversity suggests evasion attempts', de: 'Anzahl verschiedener User-Agent-Strings — hohe Diversität deutet auf Umgehungsversuche hin' },
  'profile.behavioralPatterns':   { en: 'Behavioral Patterns Detected', de: 'Erkannte Verhaltensmuster' },
  'profile.behavioralPatternsTip':{ en: 'Automatically detected suspicious behavior patterns from this IP', de: 'Automatisch erkannte verdächtige Verhaltensmuster dieser IP' },
  'profile.threatTimeline':       { en: 'Threat Score Timeline', de: 'Bedrohungsscore-Verlauf' },
  'profile.threatTimelineTip':    { en: 'Historical progression of the threat score over time', de: 'Historischer Verlauf des Bedrohungsscores über die Zeit' },
  'profile.attackDistribution':   { en: 'Attack Type Distribution', de: 'Angriffstyp-Verteilung' },
  'profile.attackDistributionTip':{ en: 'Breakdown of attack types used by this IP', de: 'Aufschlüsselung der von dieser IP verwendeten Angriffstypen' },
  'profile.uaAnalysis':           { en: 'User-Agent Analysis', de: 'User-Agent-Analyse' },
  'profile.uaAnalysisTip':       { en: 'Analysis of User-Agent strings — helps identify tools and evasion techniques', de: 'Analyse der User-Agent-Strings — hilft bei der Identifikation von Tools und Umgehungstechniken' },
  'profile.topUserAgents':        { en: 'Top User-Agents', de: 'Häufigste User-Agents' },
  'profile.recentIncidents':      { en: 'Recent Incidents', de: 'Letzte Vorfälle' },
  'profile.recentIncidentsTip':   { en: 'Chronological list of the most recent security incidents from this IP', de: 'Chronologische Liste der letzten Sicherheitsvorfälle dieser IP' },
  'profile.colTime':              { en: 'Time', de: 'Zeit' },
  'profile.colType':              { en: 'Type', de: 'Typ' },
  'profile.colMethod':            { en: 'Method', de: 'Methode' },
  'profile.colScore':             { en: 'Score', de: 'Score' },
  'profile.colLevel':             { en: 'Level', de: 'Stufe' },
  'profile.autoReactions':        { en: 'Automated Reactions', de: 'Automatische Reaktionen' },
  'profile.autoReactionsTip':     { en: 'Summary of all automated countermeasures applied to this IP', de: 'Zusammenfassung aller automatischen Gegenmaßnahmen für diese IP' },
  'profile.firstAlert':           { en: 'First alert:', de: 'Erster Alarm:' },
  'profile.blocked':              { en: 'BLOCKED', de: 'GEBLOCKT' },
  'profile.tarpitted':            { en: 'TARPITTED', de: 'VERLANGSAMT' },
  'profile.warned':               { en: 'WARNED', de: 'GEWARNT' },
  'profile.ipStatus':             { en: 'IP Status:', de: 'IP-Status:' },
  'profile.wasBlocked':           { en: 'Was blocked', de: 'War geblockt' },
  'profile.wasTarpitted':         { en: 'Was tarpitted', de: 'War verlangsamt' },
  'profile.monitored':            { en: 'Monitored', de: 'Überwacht' },
  'profile.forensicData':         { en: 'Forensic Data', de: 'Forensische Daten' },
  'profile.forensicDataTip':      { en: 'Data collected from canary document callbacks — reveals attacker device details', de: 'Daten aus Canary-Dokument-Callbacks — enthüllt Gerätedetails des Angreifers' },
  'profile.canaryCallbacks':      { en: 'Canary Callbacks', de: 'Canary-Callbacks' },
  'profile.gdprNote':             { en: 'Art. 6(1)(f) GDPR — Stored based on legitimate interest for defense against active attacks', de: 'Art. 6(1)(f) DSGVO — Speicherung aus berechtigtem Interesse zur Abwehr aktiver Angriffe' },
  'profile.canaryToken':          { en: 'Canary Token', de: 'Canary-Token' },
  'profile.document':             { en: 'Document', de: 'Dokument' },
  'profile.openerIp':             { en: 'Opener IP (Hash)', de: 'Opener-IP (Hash)' },
  'profile.downloaderIp':         { en: 'Downloader IP (Hash)', de: 'Downloader-IP (Hash)' },
  'profile.jsFingerprint':        { en: 'JS Fingerprint — Real Device Data', de: 'JS-Fingerabdruck — Echte Gerätedaten' },
  'profile.realIp':               { en: 'Real IP (WebRTC, Hash)', de: 'Echte IP (WebRTC, Hash)' },
  'profile.timezone':             { en: 'Timezone', de: 'Zeitzone' },
  'profile.language':             { en: 'Language', de: 'Sprache' },
  'profile.platform':             { en: 'Platform / OS', de: 'Plattform / OS' },
  'profile.screen':               { en: 'Screen', de: 'Bildschirm' },
  'profile.cpuCores':             { en: 'CPU Cores', de: 'CPU-Kerne' },
  'profile.ram':                  { en: 'RAM (GB)', de: 'RAM (GB)' },
  'profile.touch':                { en: 'Touch', de: 'Touch' },
  'profile.canvasHash':           { en: 'Canvas Hash', de: 'Canvas-Hash' },
  ...
  'profiles.loading':             { en: 'LOADING PROFILES...', de: 'LADE PROFILE...' },
  'profiles.failedToLoad':        { en: 'FAILED TO LOAD', de: 'LADEN FEHLGESCHLAGEN' },
  'profiles.noProfiles':          { en: 'NO ATTACKER PROFILES RECORDED', de: 'KEINE ANGREIFER-PROFILE AUFGEZEICHNET' },
  'profiles.noProfilesDesc':      { en: 'Profiles are created automatically when suspicious activity is detected.', de: 'Profile werden automatisch erstellt, wenn verdächtige Aktivität erkannt wird.' },
  'profiles.totalProfiles':       { en: 'Total Profiles', de: 'Profile gesamt' },
  'profiles.highThreat':          { en: 'High Threat', de: 'Hohe Bedrohung' },
  'profiles.activeAttackers':     { en: 'Active (24h)', de: 'Aktiv (24h)' },
  'profiles.totalIncidents':      { en: 'Total Incidents', de: 'Vorfälle gesamt' },
  'profiles.colIpHash':           { en: 'IP HASH', de: 'IP-HASH' },
  'profiles.colScore':            { en: 'SCORE', de: 'SCORE' },
  'profiles.colIncidents':        { en: 'INCIDENTS', de: 'VORFÄLLE' },
  'profiles.colAttackTypes':      { en: 'ATTACK TYPES', de: 'ANGRIFFSTYPEN' },
  'profiles.colPatterns':         { en: 'PATTERNS', de: 'MUSTER' },
  'profiles.colLastSeen':         { en: 'LAST SEEN', de: 'ZULETZT' },
  'profiles.colAction':           { en: 'ACTION', de: 'AKTION' },
  'profiles.viewDetail':          { en: 'DETAIL', de: 'DETAIL' },
  'profiles.deleteProfile':       { en: 'Delete profile', de: 'Profil löschen' },
  'profiles.deleteConfirm':       { en: 'Delete this attacker profile? This cannot be undone.', de: 'Dieses Angreifer-Profil löschen? Dies kann nicht rückgängig gemacht werden.' },
  'profiles.search':              { en: 'Search profiles...', de: 'Profile suchen...' },
  'profiles.sortBy':              { en: 'Sort by', de: 'Sortieren nach' },
  'profiles.sortScore':           { en: 'Threat Score', de: 'Bedrohungsscore' },
  'profiles.sortIncidents':       { en: 'Incidents', de: 'Vorfälle' },
  'profiles.sortLastSeen':        { en: 'Last Seen', de: 'Zuletzt gesehen' },
  'profiles.sortFirstSeen':       { en: 'First Seen', de: 'Erstmals gesehen' },
  'profiles.footer':              { en: 'ATTACKER PROFILING ACTIVE', de: 'ANGREIFER-PROFILING AKTIV' },

  // ── Blocklist Manager Dialog ────────────────────────────────────────
  'blocklist.title':              { en: 'BLOCKLIST MANAGER // HARD BLOCKS', de: 'SPERRLISTEN-MANAGER // HARD BLOCKS' },
  'blocklist.totalBlocked':       { en: 'Total Blocked', de: 'Gesamt gesperrt' },
  'blocklist.totalBlockedTip':    { en: 'Total number of IPs currently on the hard blocklist', de: 'Gesamtzahl der IPs auf der Sperrliste' },
  'blocklist.autoBlocked':        { en: 'Auto-Blocked', de: 'Auto-gesperrt' },
  'blocklist.autoBlockedTip':     { en: 'IPs automatically blocked by the threat scoring system', de: 'Automatisch durch das Bedrohungsbewertungssystem gesperrte IPs' },
  'blocklist.manualBlocked':      { en: 'Manual-Blocked', de: 'Manuell gesperrt' },
  'blocklist.manualBlockedTip':   { en: 'IPs manually added to the blocklist by an administrator', de: 'Manuell von einem Administrator zur Sperrliste hinzugefügte IPs' },
  'blocklist.addBlock':           { en: 'ADD BLOCK', de: 'SPERRE HINZUFÜGEN' },
  'blocklist.cancel':             { en: 'CANCEL', de: 'ABBRECHEN' },
  'blocklist.ipHashLabel':        { en: 'IP Hash (SHA-256)', de: 'IP-Hash (SHA-256)' },
  'blocklist.ipHashPlaceholder':  { en: 'e.g. a1b2c3d4e5f6...', de: 'z.B. a1b2c3d4e5f6...' },
  'blocklist.reasonLabel':        { en: 'Reason', de: 'Grund' },
  'blocklist.reasonPlaceholder':  { en: 'e.g. manual block, persistent attacker, etc.', de: 'z.B. manuelle Sperre, hartnäckiger Angreifer etc.' },
  'blocklist.durationLabel':      { en: 'Duration (TTL)', de: 'Dauer (TTL)' },
  'blocklist.durationTip':        { en: 'Time-to-live for the block — the IP will be automatically unblocked after this period', de: 'Gültigkeitsdauer der Sperre — die IP wird nach Ablauf automatisch entsperrt' },
  'blocklist.dur1h':              { en: '1 hour', de: '1 Stunde' },
  'blocklist.dur24h':             { en: '24 hours', de: '24 Stunden' },
  'blocklist.dur7d':              { en: '7 days', de: '7 Tage' },
  'blocklist.dur30d':             { en: '30 days', de: '30 Tage' },
  'blocklist.dur1y':              { en: '1 year', de: '1 Jahr' },
  'blocklist.blocking':           { en: 'BLOCKING...', de: 'WIRD GESPERRT...' },
  'blocklist.blockIp':            { en: 'BLOCK IP', de: 'IP SPERREN' },
  'blocklist.loading':            { en: 'LOADING BLOCKLIST...', de: 'LADE SPERRLISTE...' },
  'blocklist.failedToLoad':       { en: 'FAILED TO LOAD', de: 'LADEN FEHLGESCHLAGEN' },
  'blocklist.noBlocked':          { en: 'No blocked IPs', de: 'Keine gesperrten IPs' },
  'blocklist.allClear':           { en: 'All clear! No hard blocks active.', de: 'Alles klar! Keine aktiven Sperren.' },
  'blocklist.colIpHash':          { en: 'IP Hash', de: 'IP-Hash' },
  'blocklist.colReason':          { en: 'Reason', de: 'Grund' },
  'blocklist.colBlockedAt':       { en: 'Blocked At', de: 'Gesperrt am' },
  'blocklist.colExpires':         { en: 'Expires', de: 'Läuft ab' },
  'blocklist.colAction':          { en: 'Action', de: 'Aktion' },
  'blocklist.auto':               { en: 'AUTO', de: 'AUTO' },
  'blocklist.unblock':            { en: 'Unblock', de: 'Entsperren' },
  'blocklist.unblockConfirm':     { en: 'Unblock IP hash', de: 'IP-Hash entsperren' },
  'blocklist.cannotBeUndone':     { en: 'This cannot be undone.', de: 'Dies kann nicht rückgängig gemacht werden.' },
  'blocklist.ipUnblocked':        { en: 'IP unblocked', de: 'IP entsperrt' },
  'blocklist.failedUnblock':      { en: 'Failed to unblock', de: 'Entsperren fehlgeschlagen' },
  'blocklist.ipBlocked':          { en: 'IP blocked', de: 'IP gesperrt' },
  'blocklist.failedBlock':        { en: 'Failed to block', de: 'Sperren fehlgeschlagen' },
  'blocklist.ipHashRequired':     { en: 'IP hash is required', de: 'IP-Hash ist erforderlich' },
  'blocklist.expired':            { en: 'Expired', de: 'Abgelaufen' },
}
