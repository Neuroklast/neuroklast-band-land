...
const translations: Record<string, Record<Locale, string>> = {
  ...
  'edit.store':                { en: 'STORE', de: 'STORE' },
  'edit.resetSetup':           { en: 'RE-SETUP', de: 'NEU-SETUP' },
  'edit.password':             { en: 'PASSWORD', de: 'PASSWORT' },
  'edit.logout':               { en: 'LOGOUT', de: 'ABMELDEN' },

  // ── Admin Hub ─────────────────────────────────────────────────────────
  'hub.title':                 { en: 'ADMIN HUB', de: 'ADMIN HUB' },
  'hub.content':               { en: '📄 CONTENT', de: '📄 INHALT' },
  'hub.appearance':            { en: '🎨 APPEARANCE', de: '🎨 DARSTELLUNG' },
  'hub.analytics':             { en: '📊 ANALYTICS & SECURITY', de: '📊 ANALYTIK & SICHERHEIT' },
  'hub.communication':         { en: '📬 COMMUNICATION', de: '📬 KOMMUNIKATION' },
  'hub.system':                { en: '🔑 SYSTEM', de: '🔑 SYSTEM' },
  'hub.editContent':           { en: 'Edit Content', de: 'Inhalt bearbeiten' },
  'hub.exportData':            { en: 'Export Data', de: 'Daten exportieren' },
  'hub.importFile':            { en: 'Import File', de: 'Datei importieren' },
  'hub.syncUrl':               { en: 'Sync URL', de: 'URL synchronisieren' },
  'hub.configEditor':          { en: 'Config Editor', de: 'Konfigurationseditor' },
  'hub.themeStore':            { en: 'Theme Store', de: 'Theme Store' },
  'hub.customizer':            { en: 'Customizer', de: 'Anpassung' },
  'hub.terminal':              { en: 'Terminal', de: 'Terminal' },
  'hub.sound':                 { en: 'Sound', de: 'Sound' },
  'hub.analyticsDashboard':    { en: 'Analytics Dashboard', de: 'Analytik Dashboard' },
  'hub.securityLog':           { en: 'Security Log', de: 'Sicherheitsprotokoll' },
  'hub.securitySettings':      { en: 'Security Settings', de: 'Sicherheitseinstellungen' },
  'hub.blocklist':             { en: 'Blocklist', de: 'Sperrliste' },
  'hub.attackerProfiles':      { en: 'Attacker Profiles', de: 'Angreifer-Profile' },
  'hub.inbox':                 { en: 'Inbox', de: 'Postfach' },
  'hub.subscribers':           { en: 'Subscribers', de: 'Abonnenten' },
  'hub.marketing':             { en: 'Marketing', de: 'Marketing' },
  'hub.oauth':                 { en: 'OAuth Connections', de: 'OAuth-Verbindungen' },
  'hub.keyManager':            { en: 'Key Manager', de: 'Schlüsselverwaltung' },
  'hub.changePassword':        { en: 'Change Password', de: 'Passwort ändern' },
  'hub.resetSetup':            { en: 'Reset Setup', de: 'Setup zurücksetzen' },
  'hub.logout':                { en: 'Logout', de: 'Abmelden' },

  // ── Store ─────────────────────────────────────────────────────────────
  'store.title':               { en: 'THEME & WIDGET STORE', de: 'THEME- & WIDGET-STORE' },
  'store.search':              { en: 'Search widgets & themes…', de: 'Widgets & Themes suchen…' },
  'store.tabAll':              { en: 'All', de: 'Alle' },
  'store.tabWidgets':          { en: 'Widgets', de: 'Widgets' },
  'store.tabThemes':           { en: 'Themes', de: 'Themes' },
  'store.filterFree':          { en: 'Free', de: 'Kostenlos' },
  'store.filterPremium':       { en: 'Premium', de: 'Premium' },
  'store.install':             { en: 'Install', de: 'Installieren' },
  'store.uninstall':           { en: 'Uninstall', de: 'Deinstallieren' },
  'store.enable':              { en: 'Enable', de: 'Aktivieren' },
  'store.disable':             { en: 'Disable', de: 'Deaktivieren' },
  'store.apply':               { en: 'Apply Theme', de: 'Theme anwenden' },
  'store.applied':             { en: 'Active', de: 'Aktiv' },
  'store.installed':           { en: 'Installed', de: 'Installiert' },
  'store.free':                { en: 'FREE', de: 'GRATIS' },
  'store.premium':             { en: 'PREMIUM', de: 'PREMIUM' },
  'store.ratings':             { en: '{0} ratings', de: '{0} Bewertungen' },
  'store.noResults':           { en: 'No items match your search.', de: 'Keine Ergebnisse für Ihre Suche.' },
  'store.mixTitle':            { en: 'MIX & MATCH', de: 'MIX & MATCH' },
  'store.mixDesc':             { en: 'Combine colors, fonts, and effects from different presets into a custom theme.', de: 'Kombiniere Farben, Schriften und Effekte verschiedener Presets zu einem eigenen Theme.' },
  'store.mixColors':           { en: 'Colors from', de: 'Farben von' },
  'store.mixFonts':            { en: 'Fonts from', de: 'Schriften von' },
