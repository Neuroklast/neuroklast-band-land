      ...
      <AnimatePresence>
        {generatedKey && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -8 }}
            className="border border-status-success-em/40 rounded bg-status-success-em/10 p-4 space-y-3"
          >
            ...
            <div className="bg-black/60 rounded px-3 py-2 flex items-center gap-2">
              <code className="text-xs text-status-success-dim flex-1 break-all">{generatedKey.key}</code>
            </div>
