/**
 * DefaultNavigationSlot — default Navigation slot fallback.
 *
 * Renders the standard Navigation component, converting the theme-slot
 * `NavigationSlotProps` (items-based) into the original Navigation's
 * `sectionLabels`-based interface.
 */
...
export default function DefaultNavigationSlot({ items, siteName, onNavigate }: NavigationSlotProps) {
    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 py-3 md:py-4 flex items-center justify-between">
          ...
          >
            <span className="text-primary/60">&gt;</span> {siteName || 'Home'}
          </button>
...
DefaultNavigationSlot.displayName = 'DefaultNavigation'
