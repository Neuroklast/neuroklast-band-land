...
interface HeroZardonicProps {
  ...
  /** Top-left HUD text line 1 (default: "SYS: NK-MAIN") */
  hudTopLeft1?: string
  /** Top-left HUD text line 2 (default: "ONLINE") */
  hudTopLeft2?: string
  /** Bottom-right HUD text line 1 (default: "FREQ: 140-180") */
  hudBottomRight1?: string
  /** Bottom-right HUD text line 2 (default: "MODE: HARD") */
  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center px-4 py-16 md:py-20">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <svg className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full opacity-[0.08]" viewBox="0 0 1200 800" preserveAspectRatio="xMidYMid slice">
          <motion.polygon
          ...
          <div className="hud-element p-3 bg-black/30 backdrop-blur-sm">
            <div className="data-readout text-[9px] space-y-1">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>{hudTopLeft2}</span>
              </div>
            </div>
          </div>
        </div>

        {/* HUD bottom-right element */}
        <div className="absolute bottom-8 right-8 hidden lg:block">
          <div className="hud-element p-3 bg-black/30 backdrop-blur-sm">
            <div className="data-readout text-[9px] text-right space-y-1">
              <div>{hudBottomRight1}</div>
              <div>{hudBottomRight2}</div>
            </div>
          </div>
        </div>
        ...
        {[...Array(4)].map((_, i) => (
          ...
          >
            <svg width="20" height="20" viewBox="0 0 20 20">
              {i % 2 === 0 ? (
                <path d="M 0 0 L 10 0 L 0 10 Z" stroke="oklch(0.50 0.22 25)" strokeWidth="0.5" fill="none" />
              ) : (
                <path d="M 20 0 L 10 0 L 20 10 Z" stroke="oklch(0.50 0.22 25)" strokeWidth="0.5" fill="none" />
              )}
            </svg>
          </motion.div>
        ))}
      ...
      <div className="relative z-10 text-center max-w-5xl mx-auto">
        ...
        {/* Title image with chromatic aberration hover */}
        <motion.div
