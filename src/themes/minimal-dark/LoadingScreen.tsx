  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-2xl px-8">
        ...
        <div className="space-y-1 mb-8 h-48 overflow-hidden font-mono text-sm uppercase">
          {messages.map((msg, i) => (
            <motion.div
              key={i}
        ...
        <div className="space-y-3">
          <div className="flex justify-between text-muted-foreground font-mono text-xs uppercase">
          ...
          <div className="h-2 bg-border overflow-hidden relative">
            ...
            >
              ...
              <div className="absolute right-0 top-0 w-1 h-full bg-foreground glitch-noir-flicker shadow-[0_0_10px_var(--foreground-alpha-50)]" />
            </motion.div>
          </div>
          <div className="flex justify-between text-muted-foreground font-mono text-xs uppercase">
        ...
        <div className="mt-8 flex justify-center gap-3 font-mono text-accent items-center uppercase">
