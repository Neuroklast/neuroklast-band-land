  ...
  return (
    <div className="fixed inset-0 overflow-hidden pointer-events-none z-0" style={{ contain: 'layout' }}>
      ...
      <div className="absolute top-4 right-4 data-readout hidden md:block text-right">
        ...
        <div>{hudTexts?.topRight2 ?? sessionId}</div>
      </div>
      ...
      <svg className="absolute inset-0 w-full h-full opacity-[0.07] text-primary" preserveAspectRatio="none">
        ...
        <path d="M 0 200 L 150 200 L 180 170 L 350 170 L 380 200 L 500 200" stroke="url(#nk-circuit-grad)" strokeWidth="1" fill="none" className="cyberpunk-circuit-trace" style={{ animationDelay: '0s' }} />
      ...
      {/* Ambient radial glow */}
      <div className="absolute inset-0" style={{ background: `radial-gradient(circle at 50% 50%, var(--primary, ${NK_PRIMARY_FALLBACK}) 0%, transparent 50%)`, opacity: 0.02 }} />
