...
export const neuroklastClassicTheme: ThemePackage = {
  ...
  animations: [
    ...
    { id: 'scanlines', label: 'CRT Scanlines', defaultEnabled: true, defaultIntensity: 0.3 },
    { id: 'crt', label: 'CRT Curvature', defaultEnabled: true, defaultIntensity: 0.4 },
    { id: 'noise', label: 'Static Noise', defaultEnabled: true, defaultIntensity: 0.15 },
