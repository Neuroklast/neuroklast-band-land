...
export const vhsRetroTheme: ThemePackage = {
  ...
  animations: [
    { id: 'scanlines', label: 'VHS Tracking Lines', defaultEnabled: true, defaultIntensity: 0.5 },
    { id: 'crt', label: 'CRT Curvature', defaultEnabled: true, defaultIntensity: 0.5 },
    { id: 'noise', label: 'Tape Noise', defaultEnabled: true, defaultIntensity: 0.4 },
    { id: 'chromatic', label: 'Color Bleed', defaultEnabled: true, defaultIntensity: 0.4 },
