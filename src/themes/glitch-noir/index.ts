...
export const glitchNoirTheme: ThemePackage = {
  ...
  colorPresets: [
    ...
    {
      id: 'glitch-purple-haze',
      name: 'Purple Haze',
      description: 'Dark glitch with deep purple',
      colors: {
        primary: 'oklch(0.65 0.20 300)',
        accent: 'oklch(0.55 0.15 300)',
        background: 'oklch(0.05 0.01 300)',
        card: 'oklch(0.08 0.01 300)',
        foreground: 'oklch(0.95 0 0)',
        mutedForeground: 'oklch(0.55 0 0)',
        border: 'oklch(0.20 0.01 300)',
        secondary: 'oklch(0.12 0.01 300)',
      },
    },
    {
      id: 'glitch-crimson-dark',
      name: 'Crimson Dark',
      description: 'Noir theme with blood red glitch',
      colors: {
