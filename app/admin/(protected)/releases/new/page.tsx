    ...
    <div className="max-w-2xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <input name="artists" value={artists} onChange={(e) => setArtists(e.target.value)} className="w-full px-3 py-2 rounded bg-zinc-900 border border-zinc-700 text-white text-sm focus:outline-none" placeholder="Neuroklast, Guest Artist" />
        </div>
