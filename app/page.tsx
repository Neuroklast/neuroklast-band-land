...
async function fetchAll() {
  try {
    ...
    const [
      ...
      supabase.from('gigs').select('id, title, venue, city, country, event_date, ticket_url, festival_name, description, gig_type, status, sold_out, photo_storage_path, photo_url, event_links').eq('active', true).order('event_date', { ascending: true }),
