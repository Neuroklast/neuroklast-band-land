...
const SITE_CONFIG_TABS: AdminHelpEntry[] = [
  ...
  },
  {
    ...
    description:
      'Edit merchandise footer copy and paths to Legal Notice / Privacy Policy pages.',
    href: `${SITE_CONFIG}?tab=text`,
    group: 'Look & Feel',
    keywords: ['merchandise', 'footer', 'legal notice', 'privacy policy', 'text', 'copy'],
    priority: 70,
  },
  {
...
function navDescription(href: string, label: string): string {
  const map: Record<string, string> = {
    ...
    '/admin/members': 'Band members with photo, role and short bio on the public biography section.',
