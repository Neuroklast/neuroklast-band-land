...
const translations: Record<string, Record<string, string>> = {
  ...
  'footer.legalNotice':        { en: 'LEGAL NOTICE', de: 'IMPRESSUM', uk: 'LEGAL NOTICE', it: 'LEGAL NOTICE', es: 'LEGAL NOTICE', pt: 'LEGAL NOTICE', ja: 'LEGAL NOTICE', ko: 'LEGAL NOTICE' },
  ...
  'section.credits':           { en: 'Credit Highlights', de: 'Credits', uk: 'Кредити', it: 'Crediti', es: 'Créditos', pt: 'Créditos', ja: 'クレジット', ko: '크레딧' },
  ...
  'section.releases':          { en: 'Releases', de: 'Veröffentlichungen', uk: 'Релізи', it: 'Uscite', es: 'Lanzamientos', pt: 'Lançamentos', ja: 'リリース', ko: '릴리즈' },
  'section.merchandise':       { en: 'Merchandise', de: 'Merchandise', uk: 'Мерч', it: 'Merchandise', es: 'Merchandise', pt: 'Merchandise', ja: 'グッズ', ko: '머천다이즈' },
  'section.soundpacks':        { en: 'Soundpacks & Presets', de: 'Soundpacks & Presets', uk: 'Саундпаки та пресети', it: 'Soundpack e preset', es: 'Soundpacks y presets', pt: 'Soundpacks e presets', ja: 'サウンドパック', ko: '사운드팩' },
  'section.gigs':              { en: 'Tour Dates', de: 'Tourdaten', uk: 'Дати туру', it: 'Date del tour', es: 'Fechas de gira', pt: 'Datas de digressão', ja: 'ツアー日程', ko: '투어 일정' },
