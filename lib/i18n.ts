...
const translations: Record<string, Record<string, string>> = {
  ...
  'footer.copyrightLine':      { en: '© {0} Neuroklast', de: '© {0} Neuroklast', ru: '© {0} Neuroklast', it: '© {0} Neuroklast', es: '© {0} Neuroklast', pt: '© {0} Neuroklast', ja: '© {0} Neuroklast', ko: '© {0} Neuroklast' },
  ...
  'contact.errorInvalid':      { en: 'Please fill in all required fields correctly.', de: 'Bitte fülle alle Pflichtfelder korrekt aus.', ru: 'Заполните все обязательные поля.', it: 'Compila correttamente tutti i campi obbligatori.', es: 'Rellena todos los campos obligatorios correctamente.', pt: 'Preencha todos os campos obrigatórios corretamente.', ja: '必須項目を正しく入力してください。', ko: '필수 항목을 올바르게 입력해 주세요.' },
  'contact.errorRateLimit':    { en: 'Too many messages. Please try again in a few minutes.', de: 'Zu viele Nachrichten. Bitte versuche es in ein paar Minuten erneut.', ru: 'Слишком много сообщений. Попробуйте через несколько минут.', it: 'Troppi messaggi. Riprova tra qualche minuto.', es: 'Demasiados mensajes. Inténtalo de nuevo en unos minutos.', pt: 'Demasiadas mensagens. Tente novamente dentro de alguns minutos.', ja: '送信が多すぎます。数分後にもう一度お試しください。', ko: '메시지가 너무 많습니다. 몇 분 후에 다시 시도해 주세요.' },
