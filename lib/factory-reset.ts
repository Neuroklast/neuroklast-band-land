...
export const FACTORY_RESET_CONFIRM = 'neuroklast-factory-reset'
...
export const FACTORY_RESET_SITE_CONFIG: readonly FactorySiteConfigSeed[] = [
  { key: 'hero', value: { headline: 'NEUROKLAST', tagline: 'Industrial / Electronic', ctaLabel: 'INITIALIZE', ctaUrl: '#news', logoUrl: '/brand/neuroklast-wordmark.svg', bootSequenceEnabled: true } },
  { key: 'merchandise', value: { footerText: '' } },
