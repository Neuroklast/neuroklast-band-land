...
loadNN = loadNN.replace(/export default function LoadingScreen\(\{ onComplete, 2500 = 3000 \}\: LoadingScreenProps\) \{/, 'export default function LoadingScreen({ onComplete }: LoadingScreenProps) {\n  const duration = 2500;');
